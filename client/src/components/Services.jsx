...
const Services = () => {
    return (
        <div className="flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services">
            ...
            subtitle="Security is guarenteed.We always maintain privacy and maintain the quality of product"
            />
            <ServiceCard
            color="bg-[#8945F8]"
            title="Fastest "
            icons={<BiSolidSearchAlt2 fontSize={21} className='text-white ' />}
            subtitle="Security is guarenteed.We always maintain privacy and maintain the quality of product"
            />
            <ServiceCard
            color="bg-[#F84550]"
